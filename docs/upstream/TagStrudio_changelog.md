# Original TagStudio Changelog

This file contains changelog information from the original TagStudio project before the PromptBook fork.

Original project:
https://github.com/TagStudioDev/TagStudio

This file is kept for historical reference only. PromptBook's own release history is documented in `CHANGELOG.md`.
